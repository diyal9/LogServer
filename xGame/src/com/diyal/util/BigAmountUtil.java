...
/** 
 * @ClassName: BigAmountUtil 
 * @Description: TODO(用一句话描述这个类的作用) 
 * @author diyal.yin 
 * @date 2014-8-17 下午9:43:56 
 *  
 */
...
public final class BigAmountUtil {
	...
	public BigAmountUtil(double amount) {
		this.amount = amount;
	}
	...
	public static String toBigAmt(double amount) {
		...
		/*
		 * if(dotBig.length() == 0) return intBig +"元整"; else return intBig + 元
		 * + dotBig;
		 */
	}
	...
	private static String getNowGradeVal(String strVal, int grade) {
		...
		if (strVal.length() <= grade * GRADE)
			...
			rst = strVal.substring(strVal.length() - grade * GRADE,
					strVal.length() - (grade - 1) * GRADE);
		return rst;
	}
	...
	public static void main(String[] args) {
		System.out.println(BigAmountUtil.toBigAmt(10052345.00D));
//		System.out.println(BigAmountUtil.toBigAmt(0.00D));
//		System.out.println(BigAmountUtil.toBigAmt(0.60D));
//		System.out.println(BigAmountUtil.toBigAmt(00.60D));
//		System.out.println(BigAmountUtil.toBigAmt(150.2101D));
//		System.out.println(BigAmountUtil.toBigAmt(15400089666.234D));
//		System.out.println(BigAmountUtil.toBigAmt(22200004444.2347D));
	}
}
